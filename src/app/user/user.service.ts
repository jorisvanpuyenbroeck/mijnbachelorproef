...
export class UserService {
    ...
    constructor(private auth: AuthService, private roleService: RoleService, userStore: UserStore, private http: HttpClient, private apiConfigService: ApiConfigService) {
